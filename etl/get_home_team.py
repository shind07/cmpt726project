    ...
    for gender in genders:
        for year in years:
            for division in divisions:
                df = spark.read.csv(os.path.join(input, '{}/{}/{}/*/*/Score.csv'.format(gender, year, division)), header='true') \
                ...
                home_and_away.drop_duplicates().write.parquet(output, mode='append', compression='gzip')
